...
import com.sure.zerotoone.mapper.UserMapper;
...
import static com.sure.zerotoone.constant.UserConstant.USER_LOGIN_STATE;

/**
* @author Administrator
* @description 针对表【user(用户)】的数据库操作Service实现
* @createDate 2024-11-29 21:28:43
*/
@Service
@Slf4j
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    private static final String SALT = "SURE";
